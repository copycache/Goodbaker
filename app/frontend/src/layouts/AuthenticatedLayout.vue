...
const items = [
  ...
  { group: 'Inventory', title: 'Products', url: '/inventory/products', icon: Settings },
  { group: 'Inventory', title: 'Raw Materials', url: '/inventory/raw-materials', icon: Settings },
  { group: 'Inventory', title: 'Premixes', url: '/inventory/premixes', icon: Settings },
  { group: 'Inventory', title: 'Supplies', url: '/inventory/supplies', icon: Settings },
  { group: 'Inventory', title: 'Transfers', url: '/inventory/transfers', icon: Settings },
  { group: 'Inventory', title: 'Stock Adjustments', url: '/inventory/stock-adjustments', icon: Settings },
  { group: 'Inventory', title: 'Reorder Alerts / Minimum Stock Levels', url: '/inventory/reorder-alerts', icon: Settings },
  { group: 'Inventory', title: 'Inventory Valuation / Cost Tracking', url: '/inventory/inventory-valuation', icon: Settings },
  ...
  { group: 'Management', title: 'Users', url: '/management/users', icon: User },
  { group: 'Management', title: 'Branches', url: '/management/branches', icon: Calendar },
  { group: 'Management', title: 'Roles & Permissions', url: '/management/roles', icon: Calendar },
  { group: 'Management', title: 'Audit Logs', url: '/management/audit-logs', icon: Calendar },
